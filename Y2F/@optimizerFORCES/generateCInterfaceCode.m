...
fprintf(hFileID, '#ifndef __SOLVER_STANDARD_TYPES__\n');
fprintf(hFileID, '#define __SOLVER_STANDARD_TYPES__\n');
fprintf(hFileID, '\n');
...
fprintf(hFileID, '#define %s_SET_PRINTLEVEL    (%u)\n', constant_solverName, self.default_codeoptions.printlevel);
fprintf(hFileID, '#endif\n\n');
